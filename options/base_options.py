...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='../ugatit/datasets/ct-coltea-dataset.pkl', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='cycle_transformer', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--device', type=str, default='cuda', help='cuda or cpu')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='cycle_transformer', help='chooses which model to use. [transformer_cvt | transformer | cycle_gan | pix2pix | test | colorization]')
